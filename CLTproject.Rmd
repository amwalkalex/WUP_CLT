...
We should expect with the men giving a score of about 100 and the men giving a score of about 0, it'll result into about 50. The standard deviation will shrink down and it can be compared with the original one. It would be a quarter of what the original model is. The standard deviation shrinks as the number gets higher example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on.`r sd (my1000$k3)`
...
The standard deviation is now a quarter of what it was before which now it is 10.We expected it to be 10 and we get `r sd (my1000$k4)` 
...
The standard deviation is now 8. We expected it to be 8 and we get `r sd (my1000$k5)` 
...
The standard deviation is now a quarter of what it was before which now it is 8. We expected it to be 8 and we get `r sd (my1000$k5)` 
