...
We should expect with the men giving a score of about 100 and the men giving a score of about 0, it'll result into about 50. The standard deviation will shrink down and it can be compared with the original one. It would be a quarter of what the original model is. 

Were doing it with 9 so its expected to be divided by 
